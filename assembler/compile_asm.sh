...
files="source/main_asm.cpp source/my_assembler.cpp \
    ../general_constants_and_functions/general_const_and_func.cpp"
...
g++ -I./include -I../general_constants_and_functions $files -o assemble $flags
