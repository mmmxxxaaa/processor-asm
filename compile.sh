...
files="assembler/main_asm.cpp assembler/my_assembler.cpp my_stack/stack.cpp my_stack/my_defense.cpp processor/operations.cpp processor/processor.cpp processor/main_proc.cpp"
...
g++ -I./include $files -o stack $flags
